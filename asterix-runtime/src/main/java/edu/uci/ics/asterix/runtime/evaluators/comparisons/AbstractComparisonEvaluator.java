...
import edu.uci.ics.hyracks.data.std.util.BinaryHashSet;
import edu.uci.ics.hyracks.data.std.util.BinaryHashSet.BinaryEntry;
import edu.uci.ics.hyracks.data.std.util.BinaryHashSet.BinaryHashSetIterator;
...
public abstract class AbstractComparisonEvaluator implements ICopyEvaluator {
	...
	protected enum ComparisonResult {
		LESS_THAN, EQUAL, GREATER_THAN, UNKNOWN, CONTAINS
	}
    ...
    protected IBinaryHashFunction hashFunc = new PointableBinaryHashFunctionFactory(UTF8StringLowercasePointable.FACTORY).createBinaryHashWithoutLengthByteFunction();
